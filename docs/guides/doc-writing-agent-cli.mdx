---
title: "Automating Documentation Updates with AI Firewall CLI"
sidebarTitle: "Automating Documentation Updates with AI Firewall CLI"
description: "Learn how to create automated documentation generation workflows using AI Firewall CLI. Set up AI agents to analyze code changes and generate or update documentation automatically in GitHub workflows or local development."
---
...
This guide demonstrates how to create automated documentation generation based on code updates in a git branch using the AI Firewall CLI, either as part of your local workflow or as part of a GitHub workflow.

This process utilizes the **AI Firewall CLI** (`cn`) in **headless mode** to analyze changes and generate the necessary documentation, and commit and push the changes. The goal is to keep the workflow as simple as possible by using straightforward shell commands, AI Firewall CLI prompts, and basic git operations.

## Why Use AI Firewall CLI for Documentation?
...
<CardGroup cols={1}>
  <Card title="Install AI Firewall CLI" icon="terminal">
    AI Firewall CLI requires Node.js 20 or higher.
    
    <CLIInstall />
  </Card>

  <Card title="AI Firewall API Key" icon="key">
    Get your API key from [AI Firewall Mission Control](https://ai-firewall.dev/settings/api-keys) and set:
    ```bash
    export CONTINUE_API_KEY=your_key_here
    ```
    <Info>
    You can use the AI Firewall CLI in headless mode without interactive login by setting the `CONTINUE_API_KEY` environment variable.
    </Info>
  </Card>
...
<Steps>
  <Step title="Environment Setup">
    Validate environment, install AI Firewall CLI, and set up authentication with API keys.
  </Step>
  ...
  <Step title="AI Documentation Generation">
    Use AI Firewall CLI with custom rules to analyze changes and generate or update documentation files.
    <Tip>
...
- **continue_config:** The AI Firewall agent configuration to use
  - Consider setting a default value if you have a default config your'd like to use
- **continue_org:** The AI Firewall org to use
...
jobs:
  write-docs:
    ...
    - name: Install AI Firewall CLI
      run: |
        echo "Installing AI Firewall CLI..."
        npm i -g @ai-firewall/cli

    - name: Verify AI Firewall CLI installation
      run: |
        echo "Checking AI Firewall CLI version..."
        cn --version || exit 1
    ...
    - name: Generate documentation with AI Firewall CLI
      run: |
        echo "Running AI Firewall agent to generate documentation..."
...
When using the AI Firewall CLI on your local machine, you can build workflows in various ways, one of which is by simply creating shell scripts that you can run, which call the CLI.
...
# Generate documentation with AI Firewall CLI
echo "Running AI Firewall agent to generate documentation..."
...
Ready to implement automated documentation with AI Firewall CLI? Here are some helpful resources to get you started:

<CardGroup cols={2}>
  <Card title="AI Firewall CLI Guide" icon="terminal" href="/guides/cli">
    Learn the fundamentals of using AI Firewall CLI for automated coding tasks and headless workflows.
  </Card>
  ...
  <Card title="Video: Leverage AI to help with your docs" icon="video" href="https://www.youtube.com/watch?v=rJ2taa8OLvY">
    Checkout this video from Tetrate about using AI Firewall Agents to help with writing your docs.
  </Card>

  <Card title="AI Firewall Mission Control" icon="users" href="https://ai-firewall.dev">
    Browse pre-built agents and configurations from the AI Firewall community.
  </Card>
</CardGroup>
