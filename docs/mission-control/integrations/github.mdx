...
[Connect GitHub in Mission Control →](https://ai-firewall.dev/integrations/github)

## Access and permissions

When connecting GitHub, you choose which repositories to grant access to and approve the requested permissions. These allow AI Firewall to read repository data and open pull requests on your behalf.
