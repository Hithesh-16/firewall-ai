    ...
    <ToolTip place="top" content="Create File with Code">
      <HoverItem className="!p-0">
        <button
          ...
          className={`text-description-muted flex items-center border-none bg-transparent pl-0 text-xs text-[${vscForeground}] cursor-pointer outline-none hover:brightness-125`}
          onClick={onClick}
        >
