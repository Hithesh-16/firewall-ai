---
title: "GitHub Issues and PRs with GitHub MCP and AI Firewall"
description: "Use AI Firewall and the GitHub MCP to list, summarize, and act on open issues and recently merged pull requests with natural language prompts."
sidebarTitle: "GitHub Issues with AI Firewall"
---
...
<Card title="What You'll Build" icon="github">
  A GitHub workflow assistant that uses AI Firewall with the GitHub MCP to:
...
<Step title="Configure GitHub Token">
  Add your `GITHUB_TOKEN` to your [AI Firewall Mission Control agent's environment variables](https://ai-firewall.dev/settings).
  </Step>
</Steps>
...
<Card title="🚀 Fastest Path to Success" icon="rocket">
  Use the GitHub MCP from AI Firewall Mission Control for one-click setup, or add it via CLI.
</Card>
...
<Tabs>
  <Tab title="⚡ Quick Start (Recommended)">
    <Steps>
      <Step title="Install GitHub MCP via AI Firewall Mission Control">
        Visit the [GitHub Project Manager Agent](https://ai-firewall.dev/ai-firewall/github-project-manager-agent) on AI Firewall Mission Control and click **Install** to add it to your agent.
      ...
      <Step title="Launch the Agent">
        From your repo root:
        ```bash
        cn --agent ai-firewall/github-project-manager-agent
        ```
...
<Accordion title="Agent Requirements">
    To use GitHub MCP with AI Firewall CLI, you need either:
...
- `CONTINUE_API_KEY`: From [ai-firewall.dev/settings/api-keys](https://ai-firewall.dev/settings/api-keys)
  ...
  report:
    ...
    steps:
      ...
      - name: Post PR Context Comment
        ...
        run: |
          REPORT=$(        cn --agent ai-firewall/github-project-manager-agent \
...
<Info>
  Use `ai-firewall/github-project-manager-agent` consistently throughout your automation as the recommended agent configuration.
</Info>
...
<CardGroup cols={2}>
  <Card title="GitHub MCP (Anthropic)" icon="link" href="https://ai-firewall.dev/anthropic/github-mcp">
    Anthropic GitHub MCP on AI Firewall Mission Control
  </Card>
  <Card title="MCP in AI Firewall" icon="book" href="/customize/deep-dives/mcp">
    How MCP works with AI Firewall agents
  </Card>
  <Card title="GitHub Project Manager Agent" icon="robot" href="https://ai-firewall.dev/ai-firewall/github-project-manager-agent">
    Pre-configured agent on AI Firewall Mission Control
  </Card>
