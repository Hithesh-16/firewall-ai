---
title: "OVHcloud"
description: "Configure OVHcloud AI Endpoints with AI Firewall to access their GDPR-compliant serverless inference API for models like Qwen, Llama, Mistral, and Deepseek, with strong security and data privacy features"
---
...
Function calling is automatically enabled for supported models when using AI Firewall.
