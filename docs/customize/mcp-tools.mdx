---
title: "MCP servers"
description: "Learn how to use Model Context Protocol (MCP) blocks in AI Firewall to integrate external tools, connect databases, and extend your development environment."
---

Model Context Protocol (MCP) servers let AI Firewall connect to external tools, systems, and databases by running MCP servers.
