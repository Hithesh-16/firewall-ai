...
description: "Learn AI Firewall's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes."
sidebarTitle: "Quick Start"
---

Welcome to AI Firewall! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about AI Firewall's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  AI Firewall](/ide-extensions/install) and [signed
  in](https://auth.ai-firewall.dev/) to get started.
</Info>
...
Press **Enter** and watch AI Firewall suggest code completions. Press **Tab** to accept suggestions.

</Step>

<Step title="See the Magic">
AI Firewall will intelligently suggest function implementations based on the context and comment.
</Step>
</Steps>
...
<Step title="Watch the Magic">
  Watch AI Firewall refactor your code automatically!
</Step>

<Step title="Review Changes">
AI Firewall will show you a diff of the proposed changes. Accept or reject individual changes as needed.
</Step>
</Steps>
...
Ready to explore more? AI Firewall offers five powerful features to enhance your coding workflow:
<Tabs>
...
Congratulations! You've experienced all four core AI Firewall features. Here's what to explore next:
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="users"
    href="https://github.com/ai-firewall/ai-firewall/discussions"
  >
    Get help and share experiences with other AI Firewall users
  </Card>
</CardGroup>
...
<Info>
  **Need help?** Check our [troubleshooting guide](/troubleshooting) or ask a
  ...
  discussions](https://github.com/ai-firewall/ai-firewall/discussions).
</Info>
