  ...
  implements vscode.InlineCompletionItemProvider
{
  private async onError(e: unknown) {
    ...
    let message = "AI Firewall Autocomplete Error";
    ...
    vscode.window.showErrorMessage(message, "Documentation").then((val) => {
      if (val === "Documentation") {
        vscode.env.openExternal(
          vscode.Uri.parse(
            "https://docs.ai-firewall.dev/features/tab-autocomplete",
          ),
        );
      }
    });
    ...
    try {
      ...
      const autocompleteCompletionItem = new vscode.InlineCompletionItem(
        ...
        range,
        {
          ...
          command: "aiFirewall.logAutocompleteOutcome",
      ...
      if (isFim) {
        ...
        // Ghost text acceptance can *technically* be acted upon in the command handler for "aiFirewall.logNextEditOutcomeAccept".
        ...
        const nextEditCompletionItem = new vscode.InlineCompletionItem(
          ...
          ),
          {
            ...
            command: "aiFirewall.logNextEditOutcomeAccept",
