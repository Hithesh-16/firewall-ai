 ...
 * Prevents premature </script> closure and other HTML parsing issues.
 */
...
{
  public static readonly viewType = "aiFirewall.aiFirewallGUIView";
  ...
  getSidebarContent(
    ...
    <html lang="en">
      ...
      <body>
        ...
        <script nonce="${nonce}">
          localStorage.setItem("ide", '"vscode"');
          localStorage.setItem("vsCodeUriScheme", '"${getvsCodeUriScheme()}"');
          localStorage.setItem("extensionVersion", '"${getExtensionVersion()}"');
          window.windowId = "${this.windowId}";
          window.vscMachineId = "${getUniqueId()}";
          window.vscMediaUrl = "${vscMediaUrl}";
          window.ide = "vscode";
          window.fullColorTheme = ${safeJsonForHtml(currentTheme)};
          window.colorThemeName = "dark-plus";
          window.workspacePaths = ${safeJsonForHtml(workspacePaths)};
          window.isFullScreen = ${isFullScreen};
          ${edits ? `window.edits = ${safeJsonForHtml(edits)};` : ""}
