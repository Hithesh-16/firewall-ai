...
// Mermaid requires hex values at initialization time — these match the defaults
// from gui/src/styles/theme.ts. Mermaid does not support CSS variables directly.
