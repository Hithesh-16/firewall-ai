...
<Columns cols={2}>
<Card title="Local Rules (.ai-firewall/rules)" icon="folder">
- Create files in `.ai-firewall/rules` folder
...
- Manage on [AI Firewall Mission Control](https://ai-firewall.dev)
