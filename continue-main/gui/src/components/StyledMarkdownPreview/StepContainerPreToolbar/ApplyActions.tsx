    ...
    case "streaming":
      return (
        <div className="bg-badge flex select-none items-center rounded pl-2 pr-1">
          <span className="text-description-muted inline-flex items-center gap-2 text-center text-xs">
            Applying
            <Spinner />
          </span>
        </div>
    ...
    case "done":
      return (
        <div className="bg-badge flex select-none items-center rounded sm:gap-1 md:px-1.5">
          <span className="text-description-muted flex items-center text-center text-xs max-md:hidden">
        ...
        <ToolTip place="top" content="Apply Code">
          ...
          >
            <button
              ...
              className="text-description-muted flex cursor-pointer items-center border-none bg-transparent pl-0 text-xs outline-none hover:brightness-125"
              onClick={props.onClickApply}
            >
              <div className="text-description-muted flex items-center gap-1">
