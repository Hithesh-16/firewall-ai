...
description: "Optimize web performance with A/B testing, automated monitoring, and data-driven improvements using Netlify MCP and AI Firewall."
...
- [Netlify MCP](https://ai-firewall.dev/netlify/netlify-mcp) configured
- [Netlify Development Rules](https://ai-firewall.dev/netlify/netlify-development) (recommended)
  ...
  <Tab title="⚡ Quick Start (Recommended)">
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Netlify Continuous AI Agent](https://ai-firewall.dev/ai-firewall/netlify-continuous-ai-agent) on AI Firewall Mission Control and click **"Install Agent"** or run:
        
        ```bash
        cn --agent ai-firewall/netlify-continuous-ai-agent
        ```
...
<Step title="Configure Netlify MCP">
  ...
  `netlify login`
  2. Visit [Netlify MCP on AI Firewall
  Hub](https://ai-firewall.dev/netlify/netlify-mcp)
  3. Follow the configuration instructions for your editor

</Step>

  <Step title="Add Development Rules">
    Install the [Netlify Development Rules](https://ai-firewall.dev/netlify/netlify-development) bundle for best practices:

    1. Visit the bundle page on AI Firewall Mission Control
...
jobs:
  performance:
    ...
    steps:
      ...
      - name: Authenticate AI Firewall CLI
        env:
          CONTINUE_API_KEY: ${{ secrets.CONTINUE_API_KEY }}
        run: |
          cn auth login --api-key "$CONTINUE_API_KEY"
          echo "✅ AI Firewall CLI authenticated"
...
- Install [Netlify MCP](https://ai-firewall.dev/netlify/netlify-mcp) from AI Firewall Mission Control
...
- [Netlify MCP on AI Firewall Mission Control](https://ai-firewall.dev/netlify/netlify-mcp)
- [Core Web Vitals Guide](https://web.dev/vitals/)
- [Netlify Analytics Documentation](https://docs.netlify.com/analytics/)
- [AI Firewall Performance Guides](https://docs.ai-firewall.dev/guides)
