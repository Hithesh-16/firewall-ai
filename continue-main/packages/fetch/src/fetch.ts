import { RequestOptions } from "@ai-firewall/config-types";
...
import { extractScanHeaders } from "./scanHeaders.js";
...
export async function fetchwithRequestOptions(
  ...
  try {
    ...
    // Extract AI Firewall scan headers (fires listeners if present)
