...
Persistent permissions are stored in `~/.ai-firewall/permissions.yaml`. This file is updated when you choose "Continue + don't ask again" in the TUI approval prompt.
