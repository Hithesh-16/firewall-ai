...
// Phase H.H2 (SECURITY_HARDENING_PLAN.md, 2026-04-17): ContinueProxy
// stub deleted — the free-trial hosted gateway is gone. The test
// cases that exercised its `supportsFim()` proxy-dispatch logic have
// been removed; the surviving provider tests cover the real behavior.
import Vllm from "../Vllm.js";

// Mock the parseProxyModelName function
const mockParseProxyModelName = jest.fn();
jest.mock("@ai-firewall/config-yaml", () => ({
