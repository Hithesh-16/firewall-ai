---
title: "Secret Types"
description: "The AI Firewall Mission Control comes with secrets management built-in. Secrets are values such as API keys or endpoints that can be shared across configurations and within organizations."
---
