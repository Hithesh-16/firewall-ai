...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .ai-firewallignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".ai-firewallignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .ai-firewallignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".ai-firewallignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.ai-firewallignore", "level3/"],
    ]);
    const result = await shouldIgnore(
