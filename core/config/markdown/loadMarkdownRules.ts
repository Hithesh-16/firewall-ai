...
/**
 * Loads rules from markdown files in the .ai-firewall/rules and .ai-firewall/prompts directories
...
export async function loadMarkdownRules(ide: IDE): Promise<{
  ...
  // Load markdown files from both .ai-firewall/rules and .ai-firewall/prompts
