    ...
    <div className="flex flex-row items-center border-0 border-t border-solid border-t-zinc-700 px-3 py-0.5">
      <div className="group flex flex-1 cursor-pointer flex-row items-center gap-2">
        <div className={`flex flex-row items-center gap-2`}>
          <p className="text-description-muted m-0 p-0 text-xs group-hover:underline">
            {state.displayName}
          </p>
        </div>
        ...
        <div className="xs:flex text-description-muted hidden flex-row items-center gap-1">
          ...
          <ArrowPathIcon
            className={`animate-spin-slow text-description-muted inline-block h-4 w-4`}
          ></ArrowPathIcon>
        </div>
      </div>
      <EyeSlashIcon
        className="text-description-muted ml-6 h-4 w-4 cursor-pointer hover:opacity-80"
        onClick={(e) => {
          dispatch(
