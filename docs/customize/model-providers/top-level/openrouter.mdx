---
title: "How to Configure OpenRouter with AI Firewall"
sidebarTitle: "OpenRouter"
---

<Tip>
  **Discover OpenRouter models [here](https://ai-firewall.dev/openrouter)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://ai-firewall.dev/openrouter/qwen3-coder?view=config)**
</Info>
...
<Info>
  AI Firewall automatically uses system message tools for models that don't support
