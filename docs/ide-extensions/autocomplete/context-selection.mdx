...
description: "Learn how AI Firewall's autocomplete selects relevant code context using file content, language server definitions, imports, and recent file history."
---
