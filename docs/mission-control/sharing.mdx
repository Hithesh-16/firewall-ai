---
title: "Sharing"
description: "Connect with the AI Firewall community to discover, share, and collaborate on AI development tools."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Public" icon="globe">
    Available to everyone in AI Firewall Mission Control.  
...
## Community
<CardGroup cols={2}>
  <Card title="Join the Discussion" icon="people" href="https://github.com/ai-firewall/ai-firewall/discussions">
    Join thousands of developers using AI Firewall and share your experiences.
    </Card>
  <Card title="Share your feedback" icon="globe" href="https://github.com/ai-firewall/ai-firewall/discussions">
