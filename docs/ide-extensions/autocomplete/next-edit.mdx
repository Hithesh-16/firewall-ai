---
title: "Next Edit"
description: "Learn how AI Firewall's Next Edit feature predicts and suggests your next code changes using AI, going beyond traditional autocomplete to anticipate entire code modifications"
---

<Warning>
  Next Edit is currently an experimental feature. It requires
  [Instinct](https://ai-firewall.dev/ai-firewall/instinct) or [Mercury Coder
  model](https://ai-firewall.dev/inception/mercury-coder) configured in
  your AI Firewall autocomplete settings and is not yet available for JetBrains
  use.
</Warning>
...
<Note>
  ...
  in your AI Firewall autocomplete model settings. This model is specifically
...
- **Instinct**: The leading open Next Edit model, trained by AI Firewall

### Automatic Detection

AI Firewall automatically enables Next Edit when:
...
<Card title="Provide Feedback" icon="message">
  ...
  discussions](https://github.com/ai-firewall/ai-firewall/discussions/categories/feedback)__
  to help us improve.
</Card>

  <Card title="Combine with Other Features" icon="puzzle-piece">
    Use Next Edit alongside AI Firewall's Chat and Agent modes for comprehensive AI-assisted development.
  </Card>
</CardGroup>

---

_Next Edit represents AI Firewall's vision for proactive AI coding assistance that anticipates developer needs rather than just reacting to input. As this feature evolves, it will become a powerful tool for accelerating development workflows and reducing repetitive coding tasks._
