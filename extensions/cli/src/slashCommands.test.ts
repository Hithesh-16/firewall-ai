...
vi.mock("./env.js", () => ({
  env: {
    continueHome: "/home/test/.ai-firewall",
...
vi.mock("./session.js", () => ({
  getSessionFilePath: vi.fn(
    () => "/home/test/.ai-firewall/cli-sessions/continue-cli-pid-12345.json",
  ),
  ...
  describe("handleSlashCommands", () => {
    ...
    it("should use test session directory when in test mode", async () => {
      ...
      (getSessionFilePath as any).mockReturnValue(
        "/test-home/.ai-firewall/cli-sessions/continue-cli-test-123.json",
      );
      ...
      expect(result?.output).toContain("/test-home/.ai-firewall/cli-sessions/");
