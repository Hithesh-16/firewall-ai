...
description: "Learn how to work with AI Firewall's configuration system. Understand how to use hub models, rules, and tools, create local configurations, and organize your setup for maximum reusability."
---

## What Are Models, Rules, and Tools?

AI Firewall configs are built from three main types of configuration:
...
Pre-built models, rules, and tools from the AI Firewall community that you can import and use immediately
</Card>
</Columns>
...
AI Firewall hub uses a slug in the format of `owner/item-name` to resolve blocks.

For example, to use the [Claude 4 Sonnet model](https://ai-firewall.dev/anthropic/claude-4-sonnet), you'd reference it as `anthropic/claude-4-sonnet`.
...
- **[AI Firewall Mission Control](https://ai-firewall.dev)**: Browse community models, rules, and tools
