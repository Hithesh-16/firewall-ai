...
describe("ASSISTANTS getAllDotContinueDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    ...
    addToTestDir([
      ".ai-firewall/assistants/",
      [".ai-firewall/assistants/assistant1.yaml", "yaml content 1"],
      [".ai-firewall/assistants/assistant2.yml", "yaml content 2"],
      [".ai-firewall/assistants/assistant3.md", "markdown content 1"],
      [".ai-firewall/assistants/assistant4.txt", "txt content"],
      [".ai-firewall/assistants/config.yaml", "txt content"],
      [".ai-firewall/assistants/config.yml", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".ai-firewall/assistants/",
      [".ai-firewall/assistants/nonmatch1.txt", "txt content"],
      [".ai-firewall/assistants/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    ...
    addToTestDir([
      [".ai-firewall/assistants/assistant5.YAML", "uppercase yaml"],
      [".ai-firewall/assistants/assistant6.YML", "uppercase yml"],
      [".ai-firewall/assistants/assistant7.MD", "uppercase md"],
    ]);
...
describe("AGENTS getAllDotContinueDefinitionFiles with fileExtType option", () => {
  beforeEach(() => {
    ...
    addToTestDir([
      ".ai-firewall/agents/",
      [".ai-firewall/agents/agent1.yaml", "yaml content 1"],
      [".ai-firewall/agents/agent2.yml", "yaml content 2"],
      [".ai-firewall/agents/agent3.md", "markdown content 1"],
      [".ai-firewall/agents/agent4.txt", "txt content"],
    ]);
  });
  ...
  it("should return empty array when no files match the specified extension type", async () => {
    ...
    addToTestDir([
      ".ai-firewall/agents/",
      [".ai-firewall/agents/nonmatch1.txt", "txt content"],
      [".ai-firewall/agents/nonmatch2.json", "json content"],
    ]);
  ...
  it("should filter by file extension case sensitively", async () => {
    // Add files with uppercase extensions
    addToTestDir([
      [".ai-firewall/agents/agent5.YAML", "uppercase yaml"],
      [".ai-firewall/agents/agent6.YML", "uppercase yml"],
      [".ai-firewall/agents/agent7.MD", "uppercase md"],
    ]);
