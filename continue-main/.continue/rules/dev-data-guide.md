...
- **Default storage**: `~/.ai-firewall/dev_data/`
- **Event files**: `~/.ai-firewall/dev_data/{version}/{eventName}.jsonl`
...
data:
  - name: "Local Development Data"
    destination: "file:///Users/developer/.ai-firewall/dev_data"
    schema: "0.2.0"
    level: "all"
...
1. **Check local storage**: Verify files are being created in `~/.ai-firewall/dev_data/`
