...
<CardGroup cols={3}>
  <Card title="Privacy-First" icon="shield">
    All logs and processing happen in your runner: AI Firewall CLI runs in GitHub Actions → code to your LLM provider (OpenAI, Anthropic, etc.). No hosted Continue service reads your code.
    ...
    steps:
      ...
      - name: Post Review Comment
        ...
        run: |
          ...
          ---
          *Powered by [Continue](https://ai-firewall.dev) • Need a focused review? Comment `@review-bot check for [specific concern]`*
          EOF
...
>
> ---
> *Powered by [Continue](https://ai-firewall.dev) • Need a focused review? Comment `@review-bot check for security`*
