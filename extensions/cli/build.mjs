...
try {
  const result = await esbuild.build({
    ...
    alias: {
      "@ai-firewall/config-yaml": resolve(
        __dirname,
        "../../packages/config-yaml/dist/index.js",
      ),
      "@ai-firewall/openai-adapters": resolve(
        __dirname,
        "../../packages/openai-adapters/dist/index.js",
      ),
      "@ai-firewall/config-types": resolve(
        __dirname,
        "../../packages/config-types/dist/index.js",
      ),
      core: resolve(__dirname, "../../core"),
      "@ai-firewall/fetch": resolve(
        __dirname,
        "../../packages/fetch/dist/index.js",
      ),
      "@ai-firewall/llm-info": resolve(
        __dirname,
        "../../packages/llm-info/dist/index.js",
      ),
      "@ai-firewall/terminal-security": resolve(
        __dirname,
