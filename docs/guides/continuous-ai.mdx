...
**AI Firewall Implementation**: Using [Chat](/ide-extensions/chat/quick-start) or [Edit](/ide-extensions/edit/quick-start) mode for one-off coding tasks.
...
**AI Firewall Implementation**: Using [AI Firewall CLI](/guides/cli) with custom rules and integrations into CI/CD pipelines.
...
**AI Firewall Implementation**: Fully automated [agents](/ide-extensions/agent/quick-start) with strict permissions and safety guardrails.
...
Use AI Firewall CLI's permission system to gradually expand AI capabilities:

```yaml ~/.ai-firewall/permissions.yaml
permissions:
...
<Card title="Want to dive deeper?" icon="rocket">
      Check out our guides on [AI Firewall CLI](/guides/cli) and [Understanding
