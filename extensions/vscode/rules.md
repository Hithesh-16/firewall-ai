The `extensions/vscode` folder contains code for the "AI Firewall" VS Code Extension. AI Firewall is a coding extension which extends IDE functionality with AI.
