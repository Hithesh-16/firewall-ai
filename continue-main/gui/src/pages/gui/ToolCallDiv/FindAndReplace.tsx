        ...
        <div className="flex min-w-0 flex-1 flex-row items-center gap-2 text-xs">
          <div className="flex min-w-0 flex-row items-center">
            ...
            <ChevronDownIcon
              ...
              className={`text-description-muted h-3.5 w-3.5 flex-shrink-0 cursor-pointer select-none transition-all hover:brightness-125 ${
          ...
          if (part.removed) {
            return (
              <DiffLines
                ...
                className="border-l-4 border-error/50 bg-error/20"
                diffCharClass="text-error"
                diffChar="-"
              />
            );
          } else if (part.added) {
            return (
              <DiffLines
                key={index}
                lines={part.value.split("\n")}
                diffCharClass="text-success"
                className="border-l-4 border-success bg-success/15"
                diffChar="+"
              />
            );
          } else {
