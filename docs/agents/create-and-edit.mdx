...
description: "Build custom AI workflows for your Cloud Agents with prompts, rules, and tools through the AI Firewall Mission Control interface"
sidebarTitle: "Create & Edit"
---

<Card title="Creating Custom Cloud Agents" icon="wrench">
  You can only create and edit AI Agents in the AI Firewall Mission Control web interface. This ensures proper validation, versioning, and team collaboration features.
</Card>
...
<Steps>
  <Step title="🧭 Navigate to Create Agent">
    Navigate to the [New Agent page](https://ai-firewall.dev/agents/new).
  ...
  <Step title="🧩 Fill Out the Agent Form">
    ...
    | **Tools ([MCPs](https://ai-firewall.dev/hub?type=mcpServers))** | Select built-in or custom MCPs | `GitHub, PostHog, Supabase, etc.` |
    | **[Rules](https://ai-firewall.dev/hub?type=rules)** | Add any organizational rules | `ai-firewall/gh-pr-commit-workflow` |
    | **[Model](https://ai-firewall.dev/hub?type=models)** | Choose a default LLM | `Claude Sonnet 4.5` |
...
From the **[Agents](https://ai-firewall.dev/agents)** page, click your agent's name. Change any of the fields in the edit form, then click **"Save Changes"**.
...
<CardGroup cols={2}>
  <Card title="Security Scanner Cloud Agent" icon="shield" href="https://ai-firewall.dev/ai-firewall/snyk-continuous-ai-agent">
  ...
  <Card title="Performance Monitoring Cloud Agent" icon="gauge" href="https://ai-firewall.dev/ai-firewall/netlify-continuous-ai-agent">
  ...
  <Card title="Error Monitoring Agent" icon="bug" href="https://ai-firewall.dev/ai-firewall/sentry-continuous-ai-agent">
  ...
  <Card title="GitHub Management Cloud Agent" icon="github" href="https://ai-firewall.dev/ai-firewall/github-manager-ai-agent">
  ...
  <Card title="Database Management Cloud Agent" icon="database" href=" https://ai-firewall.dev/ai-firewall/supabase-agent">
