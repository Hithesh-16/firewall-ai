---
title: "Recommended Models for Chat in AI Firewall"
description: "Choose the best chat model for AI Firewall, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
