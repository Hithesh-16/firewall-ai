---
title: "AI Firewall Autocomplete Setup and Configuration Guide"
description: "Step-by-step guide to setting up and configuring autocomplete in AI Firewall, including Codestral, Ollama, and IDE settings."
...
## How to Set Up Autocomplete in AI Firewall with Codestral (Recommended)
...
<Tabs>
  <Tab title="Hub">
  [Mistral Codestral model block](https://ai-firewall.dev/mistral/codestral)
  </Tab>
  <Tab title="YAML">
...
## How to Set Up Autocomplete in AI Firewall with Ollama (Local Model)
...
<Tabs>
  <Tab title="Hub">
  [Ollama Qwen 2.5 Coder 1.5B model block](https://ai-firewall.dev/ollama/qwen2.5-coder-1.5b)
  </Tab>
  <Tab title="YAML">
  ```yaml title="config.yaml"
  name: My Config
...
## Autocomplete Configuration Options in AI Firewall

### Autocomplete Models Available on the AI Firewall Mission Control

Explore autocomplete model configurations on [the hub](https://ai-firewall.dev/explore/models?roles=autocomplete)

### Customize Autocomplete User Settings in the AI Firewall Extension
...
5. Check the output of the logs to find any potential errors: <kbd>cmd/ctrl</kbd> + <kbd>shift</kbd> + <kbd>P</kbd> -> "Toggle Developer Tools" -> "Console" tab in VS Code, ~/.ai-firewall/logs/core.log in JetBrains.
...
7. If you are still having issues, please let us know in our [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) and we'll help as soon as possible.
...
### How to Turn Off Autocomplete in AI Firewall (VS Code and JetBrains)

#### VS Code

Click the "AI Firewall" button in the status panel at the bottom right of the screen. The checkmark will become a "cancel" symbol and you will no longer see completions. You can click again to turn it back on.

Alternatively, open VS Code settings, search for "AI Firewall" and uncheck the box for "Enable Tab Autocomplete".
...
Open Settings -> Tools -> AI Firewall and uncheck the box for "Enable Tab Autocomplete".

#### Feedback

If you're turning off autocomplete, we'd love to hear how we can improve! Please let us know in our [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) or file an issue on GitHub.
