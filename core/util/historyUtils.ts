...
import { getAiFirewallGlobalPath } from "../util/paths.js";
...
export function toMarkDown(history: ChatMessage[], time?: Date): string {
  ...
  let content = `### [Continue](https://ai-firewall.dev) session transcript\n Exported: ${time.toLocaleString()}`;
...
export async function shareSession(
  ...
  outputDir = outputDir ?? getAiFirewallGlobalPath();
