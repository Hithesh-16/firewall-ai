...
// Array of helpful tips for AI Firewall CLI users
const AI_FIREWALL_CLI_TIPS = [
...
/**
 * Randomly selects and displays a tip from the AI_FIREWALL_CLI_TIPS array.
  ...
  const randomTip = useMemo(
    () =>
      AI_FIREWALL_CLI_TIPS[
        Math.floor(Math.random() * AI_FIREWALL_CLI_TIPS.length)
      ],
    [],
  );
...
export { AI_FIREWALL_CLI_TIPS, TipsDisplay };
