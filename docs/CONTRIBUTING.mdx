...
<Steps>
  <Step title="Go to GitHub Discussions">
    Visit the [Continue GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) page.
  </Step>
...
<Steps>
  <Step title="Install the agent from AI Firewall Mission Control">
    Visit [the Docs Assistant - Mintlify in Mission Control](https://ai-firewall.dev/ai-firewall/docs-mintlify) and click "Install" to add it to your Continue setup. This agent comes pre-configured with all our documentation standards.
...
Thank you for contributing to Continue! Your efforts help make our documentation better for everyone. To learn more about contibuting to other parts of the project, check out our [main CONTRIBUTING guide](https://github.com/ai-firewall/ai-firewall/blob/main/CONTRIBUTING.md) 🎉
