...
With AI Firewall, Cloud Agents run in [Mission Control](../../mission-control), where teams configure execution, connect tools, review outcomes, and decide which workflows become automated over time.
...
<Tabs>
  <Tab title="On-Demand Tasks">
    ...
    You can trigger agents manually (with AI Firewall, use the [AI Firewall CLI](../../cli/quickstart) or [Mission Control](../../mission-control)) when you need a one-off task that you want to review.
  ...
  <Tab title="Automated Workflows">
    ...
    <Card title="Example: Security Agent" icon="lock">
      ...
      A "[Security Agent](https://ai-firewall.dev/integrations/snyk)" automatically opens PRs for Snyk issues with high and critical security vulnerabilities and implements the fixes.
...
<AccordionGroup>
  ...
  <Accordion title="Context Access" icon="folder-open">
    ...
    - **Cloud Agents:** Full repository access + [integrated tools](https://ai-firewall.dev/integrations) (Sentry, Snyk, Linear, etc.)
...
<CardGroup cols={2}>
  <Card title="Explore Cloud Agent Integrations" icon="rocket" href="https://ai-firewall.dev/integrations">

    Browse ready-to-use AI agents in AI Firewall Mission Control.
  ...
  <Card title="Mission Control Setup" icon="terminal" href="https://ai-firewall.dev">

    Get started with AI Firewall Mission Control.
