---
title: "Venice AI"
description: "Configure Venice AI with AI Firewall to access this privacy-focused generative AI platform that supports open-source LLMs without storing private user data"
---
...
Change `~/.ai-firewall/config.json` to look like the following.
