---
title: "How to Configure Model Capabilities in AI Firewall"
...
AI Firewall needs to know what features your models support to provide the best experience. This guide explains how model capabilities work and how to configure them.

## What Are Model Capabilities?

Model capabilities tell AI Firewall what features a model supports:
...
## How AI Firewall Detects Model Capabilities

AI Firewall uses a two-tier system for determining model capabilities:

### How Automatic Detection Works (Default)

AI Firewall automatically detects capabilities based on your provider and model name. For example:
...
- [toolSupport.ts](https://github.com/ai-firewall/ai-firewall/blob/main/core/llm/toolSupport.ts) - Tool capability detection logic
- [@ai-firewall/llm-info](https://www.npmjs.com/package/@ai-firewall/llm-info) - Image support detection

### How to Configure Capabilities Manually

You can add capabilities to models that AI Firewall doesn't automatically detect in your `config.yaml`.

<Note>
  You cannot override autodetection - you can only add capabilities. AI Firewall
...
2. **Using newer models** - AI Firewall doesn't yet recognize a newly released model
...
Add tool support for a model that AI Firewall doesn't recognize:
...
<Warning>
  An empty capabilities array does not disable autodetection. AI Firewall will
...
3. **Keep AI Firewall updated** - Newer versions improve autodetection

Remember: Setting capabilities only adds to autodetection. AI Firewall will still use its built-in knowledge about your model in addition to your specified capabilities.

## Model Capability Support

This matrix shows which models support tool use and image input capabilities. AI Firewall auto-detects these capabilities, but you can override them if needed.
