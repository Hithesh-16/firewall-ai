...
let downloadYamlExtensionCodeLensDisposable: vscode.Disposable | undefined =
  undefined;
let secretCodeLensDisposable: vscode.Disposable | undefined = undefined;
...
export function registerAllCodeLensProviders(
  ...
  if (secretCodeLensDisposable) {
    secretCodeLensDisposable.dispose();
  }
  ...
  secretCodeLensDisposable = registerCodeLensProvider(
    "*",
    new providers.SecretCodeLensProvider(),
  );
  ...
  if (secretCodeLensDisposable) {
    context.subscriptions.push(secretCodeLensDisposable);
  }
