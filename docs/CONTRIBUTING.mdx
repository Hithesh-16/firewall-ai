---
title: "Contributing to AI Firewall Documentation"
sidebarTitle: "Docs Contributions"
description: "Welcome to the AI Firewall documentation! We're excited that you want to contribute. This guide will help you get started with our documentation workflow and tools."
---
...
1. **Fork and clone the repository**
   ...
   gh repo fork ai-firewall/ai-firewall
   cd continue/docs
   ```
...
<Steps>
  <Step title="Go to GitHub Discussions">
    Visit the [AI Firewall GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) page.
  </Step>
  ...
  <Step title="Provide detailed information">
    ...
    - Your environment (OS, IDE, AI Firewall version)
  </Step>
</Steps>
...
<Info>
  ...
  **Important**: All issues should start as discussions. The AI Firewall team will determine if and when a discussion should be escalated to a GitHub issue.
  
</Info>

The AI Firewall team will review discussions and may:
...
## 🤖 AI-Powered Documentation with AI Firewall

We strongly encourage using AI Firewall's AI assistance to maintain consistency and quality in our documentation. Here are three ways to set this up:
...
<Steps>
  <Step title="Install the agent from AI Firewall Mission Control">
    Visit [the Docs Assistant - Mintlify in Mission Control](https://ai-firewall.dev/ai-firewall/docs-mintlify) and click "Install" to add it to your AI Firewall setup. This agent comes pre-configured with all our documentation standards.

    <Info>
    Learn more about AI Firewall Configs in our [config documentation](/guides/understanding-configs).
    </Info>
  </Step>
  ...
  <Step title="Use the agent">
    <Tabs>
      <Tab title="Command Line">
        ```bash
        # Install the AI Firewall CLI if you haven't already
        npm install -g @ai-firewall/cli
        
        # Use the agent from the command line
        cn "Create a new guide for using the AI Firewall CLI with Linear" --config ai-firewall/docs-mintlify
        ```
      </Tab>
      
      <Tab title="IDE">
        1. Open AI Firewall in your IDE
        2. Select the "Docs Assistant - Mintlify" agent from the model dropdown
        3. Ask it to help you create or edit documentation
        
        Example prompts:
        - "Create a new guide for using the AI Firewall CLI with Linear"
...
<Steps>
  ...
  <Step title="Add the AI Firewall Docs MCP">
    Install from AI Firewall Mission Control: https://ai-firewall.dev/ai-firewall/ai-firewall-docs-mcp
    
    This MCP provides context about AI Firewall's documentation structure and standards.
  </Step>
  
  <Step title="Add Mintlify formatting rules">
    Install from AI Firewall Mission Control: https://ai-firewall.dev/mintlify/technical-writing-rule
...
2. Add frontmatter:
   ...
   ---
   ```
3. Use the AI Firewall agent to help format your content
...
1. Use the AI Firewall agent with prompts like:
...
const example = "Hello, AI Firewall!";
```
````
...
3. **Format check**: Use the AI Firewall agent to validate Mintlify formatting
...
- **Use the AI Firewall agent**: It knows our documentation standards and will save you time
...
- **Start a Discussion**: Use [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) for documentation issues, suggestions, or questions
- **AI Firewall agent questions**: Check the [AI Firewall Mission Control page](https://ai-firewall.dev/ai-firewall/docs-mintlify)
- **GitHub Discussions**: Join the [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) for community help
- **Existing docs**: Review similar pages for formatting examples
---

Thank you for contributing to AI Firewall! Your efforts help make our documentation better for everyone. To learn more about contibuting to other parts of the project, check out our [main CONTRIBUTING guide](https://github.com/ai-firewall/ai-firewall/blob/main/CONTRIBUTING.md) 🎉
