...
description: "Learn how to audit Row Level Security in your Supabase database, identify vulnerabilities, and automatically generate fixes using AI Firewall CLI and Supabase MCP."
...
<Card title="What You'll Build" icon="shield-check">
  A security audit workflow that uses AI Firewall CLI with Supabase MCP to identify RLS vulnerabilities, generate secure policies, fix permission issues, and ensure your database follows security best practices.
</Card>
...
<Tip>
  AI Firewall CLI can analyze your database schema and generate complex SQL queries - you just need to describe what you want in plain language!
</Tip>
...
<Tabs>
    ...
    **Perfect for:** Immediate database analysis with AI-powered query optimization and schema insights
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Supabase Agent](https://ai-firewall.dev/ai-firewall/supabase-agent) on AI Firewall Mission Control and click **"Install Agent"** or run:
        
        ```bash
        cn --agent ai-firewall/supabase-agent
        ```
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Supabase MCP to AI Firewall CLI">
      ...
      <Step title="Create Custom Database Analysis Prompts">
        Use this prompt template with AI Firewall CLI to analyze your database:
...
Use AI Firewall CLI to perform intelligent database analysis. Enter these prompts in the AI Firewall CLI TUI:
...
Create and apply database migrations based on AI recommendations. Enter this prompt in the AI Firewall CLI TUI:
...
Automate database health checks with AI Firewall CLI and GitHub Actions:
    ...
    steps:
      ...
      - name: Analyze Database Security
        ...
        run: |
          ...
          # Use AI Firewall CLI to audit RLS and generate fixes
...
<Card title="Continuous AI Database Management" icon="shield-check">
  Your system now operates at **[Level 2 Continuous AI](https://blog.ai-firewall.dev/what-is-continuous-ai-a-developers-guide/)** - AI handles routine database analysis and optimization with human oversight for migration approval.
</Card>
