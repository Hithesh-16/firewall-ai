...
<Note>
  ...
  **Mission Control Benefits:**
  ...
  - **Dedicated inbox view** - Monitor all Sentry-related agent activity at [ai-firewall.dev/inbox?view=sentry](https://ai-firewall.dev/inbox?view=sentry)
...
<Card title="What You'll Build" icon="bug">
  An automated error monitoring system that uses AI Firewall CLI with Sentry MCP to analyze production errors, identify root causes with AI, and create detailed GitHub issues with suggested fixes.
</Card>
...
- [AI Firewall CLI](https://docs.ai-firewall.dev/guides/cli) with **active credits** (required for API usage)
...
<Steps>
  ...
  <Step title="Set up AI Firewall CLI Account & API Key">
    1. Visit [AI Firewall Organizations](https://ai-firewall.dev/settings/organizations)
    2. Sign up or log in to your AI Firewall account
...
<Tip>
  AI Firewall CLI handles complex error analysis and API interactions - you just need to provide the right prompts!
</Tip>
...
<Tabs>
  <Tab title="Configure Sentry MCP">
    ...
    The Sentry MCP supports multiple configuration methods. For AI Firewall CLI, OAuth is recommended:
  ...
  <Tab title="Sentry API Credentials">
    ...
    3. Name it "AI Firewall CLI Error Analysis"
...
<Tabs>
    ...
    **Perfect for:** Immediate error analysis with AI-powered root cause detection and built-in debugging
    ...
    <Steps>
      <Step title="Add the Pre-Built Agent">
        Visit the [Sentry Continuous AI Agent](https://ai-firewall.dev/ai-firewall/sentry-continuous-ai-agent) on AI Firewall Mission Control and click **"Install Agent"** or run:
        
        ```bash
        cn --agent ai-firewall/sentry-continuous-ai-agent
        ```
      ...
      <Step title="Run Error Analysis">
        Navigate to your project directory and enter this prompt in the AI Firewall CLI TUI:
  ...
  <Tab title="🛠️ Manual Setup">
    <Steps>
      <Step title="Add Sentry MCP to AI Firewall CLI">
      ...
      <Step title="Create Custom Error Analysis Prompts">
        Use this prompt template with AI Firewall CLI to analyze Sentry errors:
...
<Accordion title="Agent Requirements">
  ...
  - **Your own API keys** added to AI Firewall Mission Control secrets (same as Step 1)
...
Use AI Firewall CLI to perform intelligent error analysis. Enter these prompts in the AI Firewall CLI TUI:
...
Create actionable GitHub issues from Sentry errors. Enter this prompt in the AI Firewall CLI TUI:
...
Automate error monitoring with the [Sentry Release GitHub Action](https://docs.sentry.io/product/releases/setup/release-automation/github-actions/) and AI Firewall CLI to create comprehensive, AI-powered issue descriptions:

<Tip>
  **Why Combine Sentry Releases with AI Firewall CLI?**
  - **Release Tracking**: Associate errors with specific deployments
  - **AI-Powered Analysis**: AI Firewall CLI generates detailed issue descriptions with root cause analysis
    ...
    steps:
      ...
      - name: Analyze Sentry Errors and Create Issues
        ...
        run: |
          ...
          # Use AI Firewall CLI to analyze errors and generate comprehensive issue descriptions
...
<Info>
  **Workflow Best Practices**:
  ...
  - Use AI Firewall CLI to generate comprehensive, AI-powered issue descriptions
...
<Card title="Continuous AI Error Monitoring" icon="shield-check">
  Your system now operates at **[Level 2 Continuous AI](https://blog.ai-firewall.dev/what-is-continuous-ai-a-developers-guide/)** - AI handles routine error analysis with human oversight through GitHub issue review and resolution.
</Card>

## Advanced Error Analysis Prompts

Enhance your workflow with these advanced AI Firewall CLI prompts:
...
<Warning>
  **Protect Your API Keys**:
  ...
  - Use AI Firewall CLI's secure secret storage
...
| OAuth prompt not appearing | Check that AI Firewall CLI has proper MCP configuration |
...
- Integrate [Slack MCP](https://ai-firewall.dev/slack/slack-mcp) for error alerts
- Join the [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) for support
...
- [AI Firewall CLI Guide](https://docs.ai-firewall.dev/guides/cli)
- [Continuous AI Best Practices](https://blog.ai-firewall.dev/what-is-continuous-ai-a-developers-guide/)
