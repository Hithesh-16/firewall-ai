...
export const modelCapabilitySchema = z.union([
  ...
  z.literal("next_edit"),
  z.string(), // Needed for forwards compatibility, see https://github.com/ai-firewall/ai-firewall/pull/7676
]);
...
const baseModelFields = {
  name: z.string(),
  model: z.string(),
  apiKey: z.string().optional(), // Deprecated: use apiKeyRef for vault-backed storage
  apiKeyRef: z.string().optional(), // Vault reference: "vault://provider-slug/model" (encrypted, preferred)
