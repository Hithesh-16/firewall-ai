...
import { ConfigYaml, parseConfigYaml } from "@ai-firewall/config-yaml";
import {
  ArrowPathIcon,
  ChevronDownIcon,
  CircleStackIcon,
...
function MCPServerPreview({
  ...
  const ResourceRow = ({
    ...
    return (
      <div>
        <div
          className="mx-2 flex cursor-pointer items-center justify-between rounded hover:bg-list-hover"
              ...
              <div className="space-y-1">
                {items.map((item, idx) => {
                  return (
                    <div
                      key={idx}
                      className="text-description rounded bg-input px-2 py-1 text-xs"
                    >
                      <code>{item.name}</code>
                      {item.description && (
          ...
          <Listbox>
            ...
            <ListboxOptions className="min-w-fit" anchor="bottom end">
              ...
              >
                <PencilIcon
                  className={
                    "h-3.5 w-3.5 flex-shrink-0 cursor-pointer text-inherit hover:brightness-125"
                  }
                />
                Edit
              </ListboxOption>
