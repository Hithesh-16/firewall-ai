...
For running AI Firewall completely offline without internet access, see the [Running Continue Without Internet guide](/guides/running-continue-without-internet).
...
2. **Workspace Continue folder**: Place a `.env` file in `<workspace-root>/.ai-firewall/.env`  
