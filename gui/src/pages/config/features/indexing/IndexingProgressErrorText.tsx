...
function IndexingProgressErrorText({ update }: IndexingProgressErrorTextProps) {
    ...
    return (
      <div className="flex items-center gap-2 italic">
        ...
        <span className="leading-relaxed">
          ...
          examples:
          <a
            href="https://docs.ai-firewall.dev/walkthroughs/codebase-embeddings#embeddings-providers"
            target="_blank"
            className="cursor-pointer text-inherit underline hover:text-inherit"
          >
            https://docs.ai-firewall.dev/walkthroughs/codebase-embeddings#embeddings-providers
          </a>
        </span>
      </div>
    );
  ...
  if (
    ...
    return (
      <div>
        <div
          className="flex cursor-pointer items-center gap-2 italic text-warning"
  ...
  return (
    <div className="flex items-center gap-2 italic text-error">
