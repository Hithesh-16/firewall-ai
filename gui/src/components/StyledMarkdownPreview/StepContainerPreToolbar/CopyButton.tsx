  ...
  return (
    <ToolTip place="top" content="Copy Code">
      <HoverItem className="!p-0">
        <div
          className="text-description-muted flex cursor-pointer items-center border-none bg-transparent text-xs outline-none hover:brightness-125"
          onClick={copyText}
        >
          <div className="flex items-center gap-1 transition-colors duration-200 hover:brightness-125">
            {copied ? (
              <CheckIcon className="h-3.5 w-3.5 text-success hover:brightness-125" />
            ) : (
