---
title: "Slack and Gmail Automation with Klavis AI Strata MCP and AI Firewall"
description: "Use AI Firewall and Klavis AI's Strata MCP to automate communication workflows across Slack and Gmail with natural language prompts."
sidebarTitle: "Klavis AI with AI Firewall"
---
...
<Card title="What You'll Build" icon="wand-magic-sparkles">
  A communication workflow assistant that uses AI Firewall CLI with Klavis AI's Strata MCP to manage and automate multi-platform workflows including Slack and Gmail—all through simple natural language prompts.
</Card>
...
<Tabs>
  <Tab title="Manual Setup">
    <Steps>
      <Step title="Create an Agent on AI Firewall Hub">
        Go to the [AI Firewall Hub](https://ai-firewall.dev) and [create a new agent](https://ai-firewall.dev/agents/new).
      </Step>
    ...
    <Info>
      **Pro tip**: Learn how to integrate and use [Klavis Strata](https://www.klavis.ai/docs/knowledge-base/use-mcp-server/continue) with AI Firewall through CLI and IDE.
    </Info>
  ...
  <Tab title="CLI Setup">
    <Steps>
      ...
      <Step title="Launch AI Firewall with Klavis MCP">
        ...
        Now try:
        ```
        "Send a Slack message to #general saying 'Hello from AI Firewall!'"
        ```
      </Step>
    </Steps>
  </Tab>
...
<Accordion title="Agent Requirements">
  To use Klavis AI Strata MCP with AI Firewall CLI, you need either:
  - **AI Firewall CLI Pro Plan** with the models add-on, OR
  - **Your own API keys** added to AI Firewall Hub secrets
...
<CardGroup cols={2}>
  ...
  <Card title="MCP in AI Firewall" icon="puzzle-piece" href="/customize/deep-dives/mcp">
    Learn how MCP works with AI Firewall agents
  </Card>
  <Card title="AI Firewall Hub" icon="globe" href="https://ai-firewall.dev">
    Create and manage your AI Firewall agents
  </Card>
</CardGroup>