...
export class VerticalDiffManager {
  ...
  async streamDiffLines(
    ...
    vscode.commands.executeCommand("setContext", "aiFirewall.diffVisible", true);
  ...
  async streamEdit({
    ...
    try {
      ...
      if (abortController.signal.aborted) {
        void vscode.commands.executeCommand("aiFirewall.rejectDiff");
      }
