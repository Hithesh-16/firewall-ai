...
export function RulesPeekItem({ rule }: RulesPeekItemProps) {
  ...
  return (
    <div
      className={`group mr-2 flex flex-col overflow-hidden rounded px-1.5 py-1 text-xs hover:bg-list-hover`}
    ...
    >
      <div className="flex w-full items-center">
        ...
        <div className="flex min-w-0 flex-1 gap-2 text-xs">
          ...
          <div className="min-w-0 flex-1 overflow-hidden truncate whitespace-nowrap text-xs text-description">
            {isGlobal
              ? "Always applied"
      ...
      <div className="mt-1 pl-6 pr-2 text-xs text-description">
