---
title: "How to Configure Amazon Bedrock with AI Firewall"
slug: ../bedrock
sidebarTitle: "Amazon Bedrock"
---

<Tip>
  **Discover Amazon Bedrock models [here](https://ai-firewall.dev/amazon)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://ai-firewall.dev/amazon/us-anthropic-claude-sonnet-4-20250514-v1?view=config)**
</Info>
