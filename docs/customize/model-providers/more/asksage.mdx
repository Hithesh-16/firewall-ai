...
<Tip>
  **Discover Ask Sage models [here](https://ai-firewall.dev/hub?q=Ask%20Sage)**
</Tip>
...
Add your Ask Sage model to your AI Firewall configuration file, which is located at `~/.ai-firewall/config.yaml`. If it does not exist, create it.
...
- Restart AI Firewall to apply changes.

Your Ask Sage model will now be available in AI Firewall.
...
## Setting up AI Firewall CLI

1. Install AI Firewall CLI
Follow the steps from the [official AI Firewall docs](https://docs.ai-firewall.dev/cli/quickstart).

2. Setting up a custom config for Ask Sage
Follow the steps in step 2 of the Overview above 👆.

3. How to use AI Firewall CLI
Use [AI Firewall's official guide](https://docs.ai-firewall.dev/guides/cli).
