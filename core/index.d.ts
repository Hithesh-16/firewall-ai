...
export interface IDE {
  ...
  dispatchCustomEvent?<T = any>(eventName: string, data: T): void;
...
export interface Config {
  /** If set to true, Continue will collect anonymous usage data to improve the product. If set to false, we will collect nothing. Read here to learn more: https://docs.ai-firewall.dev/telemetry */
  allowAnonymousTelemetry?: boolean;
