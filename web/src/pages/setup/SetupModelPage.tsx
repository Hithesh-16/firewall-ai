...
export default function SetupModelPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // still passes.
      // Step 1: save the provider key AND tell the proxy which
      // model the user picked. The proxy's PUT handler auto-syncs
      // the assistant YAML — it appends the model to the YAML's
      // `models:` block if it isn't already there. This means
