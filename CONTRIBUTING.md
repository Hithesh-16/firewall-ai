...
[This GitHub project board](https://github.com/orgs/ai-firewall/projects/2) is a list of ideas for how you can
...
of [good first issues](https://github.com/ai-firewall/ai-firewall/issues?q=is:issue%20state:open%20label:good-first-issue).

## 🐛 Report Bugs

If you find a bug, please [create an issue](https://github.com/ai-firewall/ai-firewall/issues) to report it! A great bug
report includes:
...
- Create an issue
  ...
  - If not, [create an issue](https://github.com/ai-firewall/ai-firewall/issues)
  - Please describe the enhancement in as much detail as you can, and why it would be useful

- Join the [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) and tell us about your idea
...
on [docs.ai-firewall.dev](https://docs.ai-firewall.dev).
...
1. Go to the [Continue GitHub repository](https://github.com/ai-firewall/ai-firewall) and fork it to your GitHub account.
...
- **For new features**: Include a short screen recording or screenshot demonstrating the new functionality. This makes it much easier for us as contributors to review and understand your changes. See [this PR](https://github.com/ai-firewall/ai-firewall/pull/6455) as a good example
...
Join the [GitHub Discussions](https://github.com/ai-firewall/ai-firewall/discussions) to engage with maintainers and other contributors.
...
providers [here](https://github.com/ai-firewall/ai-firewall/tree/main/core/llm/llms), and if you see one missing, you can
