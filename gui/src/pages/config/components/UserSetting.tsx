                  ...
                  <div className="flex flex-row items-center gap-1">
                    <ToolTip content="Save">
                      <div onClick={props.onSubmit} className="cursor-pointer">
                        <CheckIcon className="h-4 w-4 text-success hover:opacity-80" />
                      </div>
                    </ToolTip>
                    <ToolTip content="Cancel">
                      <div onClick={props.onCancel} className="cursor-pointer">
                        <XMarkIcon className="h-4 w-4 text-error hover:opacity-80" />
                      </div>
                    </ToolTip>
                  </div>
                )}
    ...
    return (
      <div className="flex flex-col gap-3">
        <div className="flex flex-col">
          ...
          <div className="mt-0.5 text-xs text-description">{description}</div>
        </div>
        {renderControl()}
      </div>
    );
