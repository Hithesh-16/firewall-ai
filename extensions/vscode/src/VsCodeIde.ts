...
class VsCodeIde implements IDE {
  ...
  async dispatchCustomEvent(eventName: string, data: any): Promise<void> {
    const protocol = await this.vscodeWebviewProtocolPromise;
    protocol.request("customEvent", { eventName, data });
  }
}
