...
vi.mock("@ai-firewall/config-yaml", async (importOriginal) => {
...
describe("ContinueProxy", () => {
  ...
  test("rerank should send a valid request", async () => {
    const proxy = new ContinueProxy({
      apiKey: "test-api-key",
      model: "test-model",
      apiBase: "https://proxy.ai-firewall.dev/model-proxy/v1/",
    });
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.ai-firewall.dev/model-proxy/v1/rerank",
        method: "POST",
        headers: {
  ...
  test("streamChat should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.ai-firewall.dev/model-proxy/v1/chat/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
  ...
  test("streamFim should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.ai-firewall.dev/model-proxy/v1/fim/completions",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  test("embed should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      expectedRequest: {
        url: "https://proxy.ai-firewall.dev/model-proxy/v1/embeddings",
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
  ...
  test("listModels should send a valid request", async () => {
    ...
    await runLlmTest({
      ...
      params: [],
      expectedRequest: {
        url: "https://proxy.ai-firewall.dev/model-proxy/v1/models",
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer test-api-key",
