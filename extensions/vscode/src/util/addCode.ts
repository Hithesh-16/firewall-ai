...
import { warnIfRestricted } from "../security/fileRestrictionChecker";
...
export async function addHighlightedCodeToContext(
  ...
  // the passed argument below was set to true in https://github.com/ai-firewall/ai-firewall/pull/6711
...
export async function addEntireFileToContext(
  ...
  // Check file restrictions before adding to AI context
  if (warnIfRestricted(uri.fsPath)) return;
