...
<CardGroup cols={2}>
  <Card
    title="Building Async Agents with AI Firewall CLI"
    icon="blog"
    href="https://blog.ai-firewall.dev/building-async-agents-with-continue-cli/"
  >
  ...
  <Card
    ...
    icon="book"
    href="https://docs.ai-firewall.dev/guides/continuous-ai"
  >
