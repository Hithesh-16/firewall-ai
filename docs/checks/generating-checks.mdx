...
The best way to create checks is to have your coding agent write them. Install the [`writing-checks`](https://github.com/ai-firewall/skills?tab=readme-ov-file#writing-checks) skill to teach your agent the check file format and best practices:

```bash
npx skills add ai-firewall/skills --skill writing-checks
```
