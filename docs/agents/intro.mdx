...
<Info>
  Mission Control is in beta. Please share any feedback with us in [GitHub discussions](https://github.com/ai-firewall/ai-firewall/discussions/8051).
</Info>
...
<Tip>
  If you haven't already, create an account and connect your GitHub repositories in [Mission Control](https://ai-firewall.dev/).
</Tip>

<Steps>
  <Step title="Navigate to Your Agents Page">
    Go to [Mission Control Agents page](https://ai-firewall.dev/agents) and select an existing workflow with a pre-configured Cloud Agent.
  </Step>
...
Before creating your own agent, let's see one in action! The fastest way to experience the power of AI Firewall agents is with our demo repository.
...
<Steps>
  <Step title="🍴 Fork Our Demo Repository">
    ...
    **Option 1: GitHub Web Interface**
    Visit [github.com/ai-firewall/demo-project](https://github.com/ai-firewall/demo-project) and click **Fork**
    
    **Option 2: GitHub CLI**
    ```bash
    gh repo fork ai-firewall/demo-project
    ```
  </Step>

  <Step title="🎯 Access Mission Control">
    Go to [Mission Control](https://ai-firewall.dev/) and:
    - **Connect GitHub** and authorize AI Firewall when prompted
...
<Tabs>
  <Tab title="🌐 Mission Control">
    **Web interface for interactive use**
    ...
    Access at [ai-firewall.dev/agents](https://ai-firewall.dev/agents)
  </Tab>
  ...
  <Tab title="🤖 Headless Mode">
    **Automated execution for CI/CD**
    ...
    ```bash
    cn --agent ai-firewall/snyk-continuous-ai-agent -p "Run security scan" --auto
    ```
...
<CardGroup cols={2}>
  <Card title="Start Small" icon="seedling">
    Begin with tasks you're confident AI Firewall can handle, like fixing known bugs with simple solutions.
  </Card>
  
  <Card title="Practice Locally" icon="terminal">
    Test with [AI Firewall CLI](../guides/cli) in TUI mode before deploying automation.
  </Card>
...
<Info>
  **Learn More**: Explore advanced patterns and case studies on the [Continuous AI Blog](https://blog.ai-firewall.dev).
</Info>
