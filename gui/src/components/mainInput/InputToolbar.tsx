    ...
    <>
      ...
      >
        ...
        >
          ...
          {isStreaming ? (
            <ToolTip place="top" content="Stop generating">
              <button
                data-testid="stop-streaming-button"
                onClick={() => dispatch({ type: "session/cancelStream" })}
                className="flex h-7 w-7 items-center justify-center rounded-md bg-primary transition-colors hover:opacity-80"
              >
