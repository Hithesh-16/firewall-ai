...
1. Make sure you have the "Enable Tab Autocomplete" setting checked (in VS Code, you can toggle by clicking the "AI Firewall" button in the status bar, and in JetBrains by going to Settings -> Tools -> Continue).
