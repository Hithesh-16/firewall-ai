---
title: "How to Configure OpenAI Models with AI Firewall"
slug: ../openai
sidebarTitle: "OpenAI"
---

<Tip>
  **Discover OpenAI models [here](https://ai-firewall.dev/openai)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://ai-firewall.dev/openai/gpt-5?view=config)**
</Info>
