...
<CardGroup cols={2}>
  <Card title="Build Your Own Agent" href="https://ai-firewall.dev/agents/new">
    Customize an agent for your team in minutes.
  </Card>
  <Card title="Cloud Agent Integrations" href="https://ai-firewall.dev/agents/integrations">
