...
describe("FreeTrialTransitionUI - URL Opening Security", () => {
  ...
  it("should verify URL format for models setup", () => {
    ...
    const baseUrl = "https://test.ai-firewall.dev";
    const expectedUrl = new URL("setup-models", baseUrl).toString();

    expect(expectedUrl).toBe("https://test.ai-firewall.dev/setup-models");
  });
  ...
  it("should handle URL construction with different base URLs", () => {
    ...
    const testCases = [
      {
        base: "https://ai-firewall.dev",
        expected: "https://ai-firewall.dev/setup-models",
      },
      {
        base: "https://app.ai-firewall.dev",
        expected: "https://app.ai-firewall.dev/setup-models",
      },
      {
