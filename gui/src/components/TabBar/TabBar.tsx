...
const tabForegroundVar = varWithFallback("description"); // --vscode-tab-inactiveForeground
...
const tabSelectedBackgroundVar = varWithFallback("list-active"); // --vscode-tab-activeBackground
...
const Tab = styled.div<{ isActive: boolean }>`
  ...
  border: none;
  border-bottom: ${(props) =>
    props.isActive ? `2px solid ${tabAccentVar}` : "2px solid transparent"};
