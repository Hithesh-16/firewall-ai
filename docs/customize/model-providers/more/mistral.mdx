...
<Tip>
  **Discover Mistral models [here](https://ai-firewall.dev/mistral)**
</Tip>
...
<Info>
  **Check out a more advanced configuration [here](https://ai-firewall.dev/mistral/codestral?view=config)**
</Info>
