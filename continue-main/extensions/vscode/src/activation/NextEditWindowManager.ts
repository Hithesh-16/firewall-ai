...
export const HIDE_NEXT_EDIT_SUGGESTION_COMMAND =
  "aiFirewall.nextEditWindow.hideNextEditSuggestion";
export const ACCEPT_NEXT_EDIT_SUGGESTION_COMMAND =
  "aiFirewall.nextEditWindow.acceptNextEditSuggestion";
...
export class NextEditWindowManager {
  ...
  private constructor() {
    ...
    // Theme initialization logged only at trace level to avoid output noise
    this.setupListeners();
  ...
  private setupListeners() {
    ...
    vscode.window.onDidChangeActiveColorTheme(async () => {
      this.theme = getThemeString();
      await this.codeRenderer.setTheme(this.theme);
      // Active theme change handled silently
    });
