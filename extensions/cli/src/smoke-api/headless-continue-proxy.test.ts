...
const AI_FIREWALL_API_KEY = process.env.AI_FIREWALL_API_KEY;
...
// SMOKE_PROXY_MODEL to be set (e.g. "ai-firewall/default/anthropic/claude-3-haiku-20240307")
const SMOKE_PROXY_MODEL = process.env.SMOKE_PROXY_MODEL;

describe.skipIf(!AI_FIREWALL_API_KEY || !SMOKE_PROXY_MODEL)(
  ...
  () => {
    ...
    beforeEach(async () => {
      ...
      await writeContinueProxyConfig(ctx, AI_FIREWALL_API_KEY!);
    });
