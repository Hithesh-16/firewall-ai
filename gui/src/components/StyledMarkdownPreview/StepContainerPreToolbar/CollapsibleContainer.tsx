        ...
        <div className="from-editor absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t to-transparent">
          ...
          >
            <span title="Expand to show full content">
              <ChevronDownIcon className="text-description-muted group-hover:text-foreground h-4 w-4" />
            </span>
          </div>
        </div>
      )}
      ...
      {isExpanded && (
        ...
        >
          <span title="Collapse to compact view">
            <ChevronDownIcon className="text-description-muted group-hover:text-foreground h-4 w-4 rotate-180" />
          </span>
        </div>
      )}
    </div>
