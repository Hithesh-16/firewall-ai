...
1. AI Firewall sends a special system message instructing the model to focus on understanding and planning
...
<Info>
  ...
  are not filtered by AI Firewall. Some MCP tools may have write capabilities that
...
<Info>
  ...
  the
  code](https://github.com/ai-firewall/ai-firewall/blob/main/core/llm/defaultSystemMessages.ts).
</Info>
