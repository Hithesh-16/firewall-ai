...
export function CliInstallBanner({
  ...
  const { copyText } = useCopy("npm i -g @ai-firewall/cli");
            ...
            <div className="text-description mt-1 text-sm">
              ...
              <span
                onClick={() =>
                  ideMessenger.post(
                    "openUrl",
                    "https://docs.ai-firewall.dev/guides/cli",
                  )
                }
          ...
          <div className="flex flex-col items-start gap-2 self-stretch">
            <div className="rounded-default outline-command-border flex items-center self-stretch outline outline-1">
              ...
              <div className="bg-background rounded-r-default flex items-center gap-2 px-3 py-3">
                <CopyButton
                  text={`npm i -g @ai-firewall/cli && cn "Explore this repo and provide a concise summary of it's contents"`}
                />
                <RunInTerminalButton
                  command={`npm i -g @ai-firewall/cli && cn "Explore this repo and provide a concise summary of it's contents"`}
                />
              </div>
            </div>
          </div>
