---
title: "Recommended Models for Autocomplete in AI Firewall"
description: "Choose the best autocomplete model for AI Firewall, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models."
...
For proactive code prediction that anticipates your next edit, AI Firewall supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
