...
```typescript
import { Continue } from "@ai-firewall/sdk";
...
// Make calls to the AI Firewall API
...
- `baseURL` (string, optional): Base URL for the AI Firewall API (defaults to `https://api.ai-firewall.dev/`)
