...
API for AI Firewall IDE to fetch assistants and other related information.
These endpoints are primarily used by the AI Firewall IDE extensions for VS Code and JetBrains.
...
- Build package: org.openapitools.codegen.languages.PythonClientCodegen
  For more information, please visit [https://ai-firewall.dev](https://ai-firewall.dev)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    always_use_proxy = 'always_use_proxy_example' # str | Whether to always use the AI Firewall-managed proxy for model requests (optional)
