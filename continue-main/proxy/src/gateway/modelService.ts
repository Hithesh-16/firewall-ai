...
export function addModel(
  ...
  const result = db.insert(models).values({
    providerId,
    modelName,
...
export function updateModel(
  ...
  if (updates.inputCostPer1k !== undefined) setObj.inputCostPer1k = updates.inputCostPer1k;
  if (updates.outputCostPer1k !== undefined) setObj.outputCostPer1k = updates.outputCostPer1k;
  if (updates.maxContextTokens !== undefined) setObj.maxContextTokens = updates.maxContextTokens;
