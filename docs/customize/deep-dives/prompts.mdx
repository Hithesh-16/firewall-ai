---
title: "How to Create and Manage Prompts in AI Firewall"
...
<Info>You can read the rest of the `Create Supabase functions` prompt [here](http://ai-firewall.dev/supabase/create-functions)</Info>
...
If you are using AI Firewall Mission Control, you can add it to your config by selecting "Use Rule" [here](https://ai-firewall.dev/supabase/create-functions)
...
You can run this command to start [cn](../../guides/cli) with the [Create Supabase functions](http://ai-firewall.dev/supabase/create-functions) prompt.
...
<Info>You can see the entire `Create Supabase functions` prompt [here](http://ai-firewall.dev/supabase/create-functions)</Info>
