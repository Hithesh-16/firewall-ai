...
{
  public static readonly viewType = "aiFirewall.aiFirewallConsoleView";
  ...
  private getSidebarContent(
    ...
    <html lang="en">
      ...
      <body>
        <style nonce="${nonce}">body { --af-emerald: var(--vscode-button-background, #059669); --af-emerald-light: var(--vscode-button-hoverBackground, #10b981); --af-cyan: var(--vscode-focusBorder, #06b6d4); --af-surface: var(--vscode-sideBar-background, #1e293b); }</style>
        <div id="root"></div>
