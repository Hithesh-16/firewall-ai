...
Rules guide agent mode's behavior and understanding. Place markdown files in `.ai-firewall/rules` in your project to provide context:
...
[DeepWiki MCP](https://ai-firewall.dev/deepwiki/deepwiki-mcp) lets agent mode explore any public GitHub repository.
...
[Context7 MCP](https://ai-firewall.dev/upstash/context7-mcp) enables agent mode to search and retrieve information from public documentation:
...
2. **Add rules**: Create `.ai-firewall/rules` files to provide context about your project structure
...
The new approach provides better integration with AI Firewall's Agent mode features and more intelligent context selection.

## Next Steps

- Learn more about [MCP servers](/reference/ai-firewall-mcp)
