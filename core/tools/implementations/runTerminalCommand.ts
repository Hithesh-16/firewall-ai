...
import { scanTerminalOutput } from "../util/scanTerminalOutput";
      ...
      try {
        ...
        return new Promise((resolve, reject) => {
          ...
          childProc.on("close", (code) => {
            ...
            // Scan terminal output for secrets/PII before returning to LLM context
            const { scannedOutput } = scanTerminalOutput(terminalOutput);
